...
SMTP_SETTINGS_DEFAULT_MAILRU = (
    "Настройки SMTP-сервера установлены по умолчанию (tn.sender@mail.ru). Можно отправлять файлы!"
)
SMTP_SETTINGS_DEFAULT_GMAIL = (
    "Настройки SMTP-сервера установлены по умолчанию (tn.sender13@gmail.com). Можно отправлять файлы!"
)
