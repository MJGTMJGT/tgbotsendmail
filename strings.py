...
CHANGE_SMTP_PROMPT_PASS = "Отправьте свой SMTP-сервер (например, smtp.mail.ru или smtp.gmail.com) или отправьте пароль для выбора SMTP-сервера по умолчанию:"
...
SMTP_SETTINGS_DEFAULT_MAILRU = "Настройки SMTP-сервера установлены по умолчанию (sender@mail.ru). Можно отправлять файлы!"

SMTP_SETTINGS_DEFAULT_GMAIL = "Настройки SMTP-сервера установлены по умолчанию (sender@gmail.com). Можно отправлять файлы!"
